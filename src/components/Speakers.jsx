                        ...
                        <div className="speakers__people_person">
                            <figure className="speakers__people_person_image_overlay">
                                ...
                                <figcaption className="icons">
                                    <a className="socialIcon" href={"http://" + speaker.instagram_account}><img src={'static/img/src/assets/images/instagram.svg'} width="20px" /></a>
                                    <a className="socialIcon" href={"http://" + speaker.linkedin_account}><img src={'static/img/src/assets/images/linkedin.svg'} width="20px" /></a>
                                </figcaption>
                            </figure>
